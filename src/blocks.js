...
SyntaxElementMorph.prototype.setScale = function (num) {
    ...
    this.scale = scale;
    this.corner = 3 * scale;
    this.rounding = 10 * scale;
    this.edge = scale;
    this.flatEdge = scale * 0.5;
    this.jag = 1 ;
    this.inset = 1;
    this.hatHeight = 1 * scale;
    this.hatWidth = 3 * scale;
    ...
    this.activeHighlight = new Color(0, 255, 0);
...
BlockMorph.prototype.init = function () {
    ...
    Object.defineProperty(this,'selector',{
        get(){
            if ((this.select === "doReport") && (((this.parentThatIsA(ReporterBlockMorph)||{}).selector||"").endsWith("Function"))){
                return 'Return'
            }
            if ((this.select === "Return") && (!((this.parentThatIsA(ReporterBlockMorph)||{}).selector||"").endsWith("Function"))) {
                return 'doReport'
            }
            return this.select
        },
